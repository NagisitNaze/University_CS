...
//	Always prints...
	...
	cout << dashes << endl << "Job Heap (level order):" << endl;
	myHeap0.printJobHeap();

	cout << dashes << endl << "Heap Size: " << myHeap0.entries() << endl;
...
//  Some very basic testing.
	...
	if (doPrint) {
		cout << dashes << endl << "Job Heap:" << endl;
		myHeap1.printJobHeap();
	}

	cout << dashes << endl << "Heap Size: " << myHeap1.entries() << endl;
	cout << "Job Priority Order:" << endl;
...
//  Some very basic testing.
	...
	if (doPrint) {
		cout << dashes << endl << "Heap Size: " <<
			myHeap2.entries() << endl;
...
//  Some very basic testing.
	...
	if(doPrint) {
		cout << dashes << endl;
		cout << "Original Heap Size: " <<
			myHeap3.entries() << endl;
